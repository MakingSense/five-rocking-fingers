        ...
        public void ValidateSettings_AwsEc2Gp2_RetunsTrue()
        {
            ...
            var artifact = new Artifact()
            {
                ...
                Settings = new XElement("settings",
                    ...
                    new XElement("termType", "Reserved"),
                    ...
                    new XElement("transferType1", "IntraRegion"),
                    new XElement("fromLocation1", "US West (N. California)"),
                    new XElement("toLocation1", "US West (N. California)"),
                    ...
                    new XElement("product1",                        
                        ...
                        new XElement("leaseContractLength", null),
                        new XElement("offeringClass", null),
                        new XElement("purchaseOption", null),
                        new XElement("pricingDimensions",
                            new XElement("range0",
