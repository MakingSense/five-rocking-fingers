    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Category, Categories.CategoryDTO>()
                .ReverseMap();
            CreateMap<Categories.CategoryDTO, Category>();
            CreateMap<Artifact, ArtifactDTO>()
                .ReverseMap()
                .ForMember(dest => dest.ArtifactTypeId, opt => opt.MapFrom(src => src.ArtifactType.Id))
                .ForMember(dest => dest.ProjectId, opt => opt.MapFrom(src => src.ProjectId));
            CreateMap<Artifact, ArtifactUpsertDTO>()
                .ReverseMap()
                .ForMember(dest => dest.ArtifactTypeId, opt => opt.MapFrom(src => src.ArtifactTypeId))
                .ForMember(dest => dest.ProjectId, opt => opt.MapFrom(src => src.ProjectId));
